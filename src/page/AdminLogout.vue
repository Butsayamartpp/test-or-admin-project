...
.top-bar {
  ...
  align-items: center;
  background-color: #6c91d8; /* สีฟ้าตามแบบ */
  color: white;
  padding: 16px 20px;
}
...
.modal-overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(153, 153, 153, 0.85); /* พื้นหลังสีเทาโปร่งแสง */
  display: flex;
...
.btn-cancel {
  background-color: #6c91d8; /* สีฟ้า */
}

.btn-confirm {
  background-color: #4eb09b; /* สีเขียวอมฟ้า */
}
</style>